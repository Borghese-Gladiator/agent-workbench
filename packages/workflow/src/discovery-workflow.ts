...
/**
 * Repository discovery as a first-class Temporal workflow. Discovery does
 ...
 * execution (previously it ran as synchronous daemon-route logic, now resolved by this workflow).
 * One execution per onboarding/refresh; short-lived.
 */
